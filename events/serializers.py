...
class EventSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Event
        fields = ['id', 'title', 'description', 'date', 'time', 'organizer','organizer_image', 'location', 'is_online', 'type', 'tags', 'organizer', 'attendees', 'is_free', 'price', 'spots_left', 'images', 'uploaded_images']
